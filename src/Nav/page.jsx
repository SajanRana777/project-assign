...
import Twoline from "../assets/side.png";
...
const page = () => {
  ...
  return (
    <section className="container">
      <div className="Na">
        <div>
        <img src={Twoline} className="twoline" />
        </div>
      ...
      <div className="main-content">
        <div className="content">
          <img src="https://placehold.co/533x570" alt="" className="img1" />
      ...
      <div className="creative">
        ...
        <img src="https://placehold.co/620x707" alt="" className="img" />
      ...
      <div className="pdiv">
        ...
        <p className="parag">
          ...
          adopters aunch party innovator creative niche market low hanging
          fruit.
        </p>
      </div>
...
<div>
      ...
      <div className="business">
        <p>
        Business plan seed money value proposition startup client direct mailing bootstrapping MVP success hypotheses gen-z pivot iteration ecosystem.
        Hackathon burn rate influencer business-to-business series A financing
        metrics low hanging fruit advisor alpha iPhone disruptive seed round.
     ...
     <div className="select">
      <div className="select-main">
        ...
        <div className=" class2" >
          <div >
           <img src="https://placehold.co/484x506" alt="" className="img2" /> 
           </div>
           <div >
           <img src="https://placehold.co/484x506" alt="" className="img2" />  
           </div>
           <div>
            <img src="https://placehold.co/484x506" alt="" className="img3" /> 
           </div>
